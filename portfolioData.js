window.portfolioData = {
  name: "Ray Mhlongo",
  role: "Data Analyst",
  summary: "I clean messy data, build clear dashboards, design analytical projects, and turn business questions into practical solutions.",
  about: [
  ...
  whyHireMe: [
    ...
    "My experience extends beyond dashboards and reports. I understand how data moves through systems, how technology supports business operations, and how analytical insights can be transformed into practical solutions.",
    "I have designed analytical projects, built real software products, developed business applications, created automation solutions, and worked with data across multiple domains including technology, healthcare, education, and market intelligence.",
    "This combination allows me to approach problems from both a technical and business perspective while delivering solutions that are practical, scalable, and data driven."
  ],
  strengths: [
